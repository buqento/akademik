...
class Paket extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kdpaket, nama, biaya', 'required'),
			array('biaya', 'numerical', 'integerOnly'=>true),
			array('kdpaket', 'length', 'max'=>50),
			array('nama', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('kdpaket, nama, biaya', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('kdpaket',$this->kdpaket,true);
